...
public class ProductController {
    ...
    public ResponseEntity<List<Product>> getListNewest(@PathVariable int number){
        List<Product> list = productService.getListNewest(number);
        return ResponseEntity.ok(list);
    }
    ...
    @Operation(summary="Tìm sản phẩm bằng id và cập nhật sản phẩm đó")
    public ResponseEntity<Product> updateQuantityProduct(@PathVariable long id,@RequestBody UpdateQuantityProductRequest request){
        Product product = productService.updateQuantityProduct(id, request);
